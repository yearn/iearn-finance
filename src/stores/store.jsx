...
class Store {
        ...
        (err) => {
          ...
          this._callDepositContract(
            ...
            (err, txnHash, depositResult) => {
              ...
              if (txnHash) {
                return emitter.emit(DEPOSIT_ALL_CONTRACT_RETURNED, txnHash);
              }
              if (depositResult) {
                return emitter.emit(
                  DEPOSIT_ALL_CONTRACT_RETURNED_COMPLETED,
  ...
  _callWithdrawVaultProxy = async (asset, account, amount, callback) => {
    ...
    yVaultCheckContract.methods
      ...
      .on("confirmation", function (confirmationNumber, receipt) {
        console.log("Confirmation", confirmationNumber, receipt);
        callback(null, confirmationNumber, receipt);
      })
      .on("receipt", function (receipt) {
        console.log(receipt);
      })
        ...
        (err) => {
          ...
          this._callWithdrawAllVaultProxy(
            ...
            (err, txnHash, withdrawResult) => {
              ...
              if (txnHash) {
                return emitter.emit(WITHDRAW_BOTH_VAULT_RETURNED, txnHash);
              }
              if (withdrawResult) {
                return emitter.emit(
                  WITHDRAW_BOTH_VAULT_RETURNED_COMPLETED,
