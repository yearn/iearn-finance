...
import {
  ...
  COVER_CLAIM,
  COVER_CLAIM_RETURNED,
  COVER_REDEEM,
  COVER_REDEEM_RETURNED
} from '../../constants'
...
class NewCover extends Component {
  ...
  componentWillMount() {
    ...
    emitter.on(COVER_REDEEM_RETURNED, this.showHash);
    emitter.on(COVER_CLAIM_RETURNED, this.showHash);
  }
  ...
  componentWillUnmount() {
    ...
    emitter.removeListener(COVER_REDEEM_RETURNED, this.showHash);
    emitter.removeListener(COVER_CLAIM_RETURNED, this.showHash);
  };
  ...
  renderCoverTable = () =>  {
    ...
    const { classes } = this.props
    const { coverProtocols, page, rowsPerPage, tabValue } = this.state
