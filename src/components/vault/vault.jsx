...
class Vault extends Component {
  ...
  componentWillMount() {
    ...
    emitter.on(DEPOSIT_CONTRACT_RETURNED_COMPLETED, this.showDepositCompleted);
    emitter.on(WITHDRAW_VAULT_RETURNED, this.showHash);
    emitter.on(WITHDRAW_VAULT_RETURNED_COMPLETED, this.showWithdrawalCompleted);
    emitter.on(DEPOSIT_ALL_CONTRACT_RETURNED, this.showHash);
    emitter.on(
      DEPOSIT_ALL_CONTRACT_RETURNED_COMPLETED,
      this.showDepositCompleted
    );
    emitter.on(WITHDRAW_BOTH_VAULT_RETURNED, this.showHash);
    emitter.on(
      WITHDRAW_BOTH_VAULT_RETURNED_COMPLETED,
      this.showWithdrawalCompleted
    );
  ...
  showWithdrawalCompleted = (txHash) => {
    const snackbarObj = { snackbarMessage: null, snackbarType: null };
    this.setState(snackbarObj);
    this.setState({ loading: false });
    const that = this;
          ...
          <div className={classes.connectWalletContainer}>
            <div className={classes.investedContainerLoggedOut}>
              <Typography variant={"h2"} className={classes.welcomeText}>
                Welcome to DAOventures
              </Typography>
              <Typography className={classes.titleDesc} variant={"body1"}>
                Connect an Ethereum wallet to manage and invest your DeFi
                portfolio
              </Typography>
              <Typography variant="body1" className={classes.alertDesc}>
                Alert: The deposit into any of investment strategies will incur
                high gas fees due to Ethereum network
              </Typography>
              ...
              <div className={classes.descriptionContainer}>
                <div className={classes.shieldContainer}>
                  <img alt="" src={require("../../assets/shield.svg")} />
                </div>
                <Typography variant="h3" className={classes.subtitle}>
                  Non-custodial & Secure
                </Typography>
                <Typography variant="body2" className={classes.securityDesc}>
                  We do not own your private keys and cannot access your funds.
                </Typography>
              </div>
            </div>
            <Typography variant="body1" className={classes.warningMessage}>
              *Crypto is volatile, DeFi is new and risky. Please use it at your
              own risk.
            </Typography>
          </div>
        ...
        return (
          <div key={index} className={classes.strategyContainer}>
            ...
            >
              <AccordionSummary
                expandIcon={
                  <ExpandMoreIcon className={classes.roundIconClass} />
                }
