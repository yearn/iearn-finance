    ...
    return( 
          <div className={ classes.disaclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
            ...
            <Typography variant="body1">
              Yearn is only possible due to community contributions. Vault strategy contributors are rewarded with <em>0.5% of additional yield</em> generated by the vaults. <a href="https://docs.yearn.finance/how-to-guides/how-to-contribute-a-yvault-strategy/" target="_blank">Learn more &rarr;</a>
            </Typography>
          </div>
    )
  }
