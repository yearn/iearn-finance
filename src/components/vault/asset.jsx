...
class Asset extends Component {
  ...
  componentWillMount() {
    emitter.on(DEPOSIT_CONTRACT_RETURNED_COMPLETED, this.depositReturned);
    emitter.on(WITHDRAW_VAULT_RETURNED_COMPLETED, this.withdrawReturned);
    emitter.on(DEPOSIT_ALL_CONTRACT_RETURNED_COMPLETED, this.depositReturned);
        ...
        <div className={classes.actionsContainer}>
          <div className={classes.tradeContainer}>
            ...
            <div className={classes.scaleContainer}>
              ...
              <Button
                className={
                  percent === 100 ? classes.scaleActive : classes.scale
                }
                variant="text"
                disabled={loading}
                onClick={() => {
          ...
          <div className={classes.tradeContainer}>
              ...
              <div className={classes.withdrawContainer}>
                <div className={classes.tradeContainer}>
                  ...
                  >
                    ...
                    {asset.symbol} (
                    {asset.earnBalance
                      ? (Math.floor(asset.earnBalance * 10000) / 10000).toFixed(
                          4
                        )
                      : "0.0000"}{" "}
                    {asset.vaultSymbol}){" "}
                  ...
                  <div className={classes.scaleContainer}>
                    <Button
                      className={
                        earnPercent === 25 ? classes.scaleActive : classes.scale
                      }
                      variant="text"
                      disabled={loading}
                      color="primary"
                    ...
                    <Button
                      className={
                        earnPercent === 50 ? classes.scaleActive : classes.scale
                      }
                      variant="text"
                      disabled={loading}
                      color="primary"
                    ...
                    <Button
                      className={
                        earnPercent === 75 ? classes.scaleActive : classes.scale
                      }
                      variant="text"
                      disabled={loading}
                      color="primary"
              ...
              <div className={classes.withdrawContainer}>
                <div className={classes.tradeContainer}>
                  ...
                  >
                    ...
                    {asset.strategyBalance
                      ? (
                          Math.floor(asset.strategyBalance * 10000) / 10000
                        ).toFixed(4)
                      : "0.0000"}{" "}
                    {asset.vaultSymbol}){" "}
                  </Typography>
            ...
            <div className={classes.buttons}>
              {asset.withdraw === true && (
                ...
                >
                  <Typography
                    className={classes.withdrawButtonText}
                    variant={"h5"}
                  >
                    Withdraw
                  </Typography>
  ...
  onDepositAll = () => {
    ...
    this.setState({ loading: true, amount: asset.balance });
    startLoading();
